...
const ContactForm = () => {
  ...
  return (
    <div className="bg-white p-8 drop-shadow-lg max-w-screen-sm max-h-80">
      <form
        action="/contacts"
        onSubmit={handleSubmit}
        className="flex flex-col space-y-4"
      >
        <h2 className="self-center text-2xl font-timeroman text-black">
          Add Contect
        </h2>
        <div>
        ...
        <button
          type="submit"
          className="w-3/4 bg-black text-white p-2 self-center px-4 py-2 rounded-md"
        >
          Save Number
        </button>
      </form>
